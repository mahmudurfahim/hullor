...
const PRODUCTS = [
 ...
 { 
  ...
  id: "SHCMWH",
  code: "SHCMWH",
  name: "শার্ট + প্যান্ট কম্বো",
  category: "combo",
  fabric: "কম্বো অনুযায়ী মিশ্র ফেব্রিক",
  fit: "রেগুলার ফিট",
  care: "প্রতিটি আইটেমের কেয়ার লেবেল অনুসরণ করুন",
  price: 999,
  oldPrice: 1500,
  image: "/images/SHCMWH.jpg",
  sizes: ["M", "L", "XL", "XXL"],
  desc: "আপনার প্রিয় মানুষকে দেওয়ার জন্য একটি স্টাইলিশ ও স্মরণীয় গিফট কম্বো। জন্মদিন, ভালোবাসার মানুষ, বন্ধু, ভাই কিংবা যেকোনো বিশেষ উপলক্ষের জন্য উপযুক্ত। কম্বোতে রয়েছে একটি স্টাইলিশ শার্ট, একটি প্রিমিয়াম घड़ি, एकटि मानिब्याग, एकटि बडी स्प्रे, एकटि ट्रेन्डि सानग्लास, एकटि फ्याशनेबल बेल्ट एवं एकटि गिफट चिरकुट।"
},

{ 
  id: "SHCMNVB",
  code: "SHCMNVB",
  name: "পোলো + ড্রপ শোল্ডার কম্বো",
  category: "combo",
  fabric: "কম্বো অনুযায়ী মিশ্র ফেব্রিক",
  fit: "রেগুলার ফিট",
  care: "প্রতিটি আইটেমের কেয়ার লেবেল অনুসরণ করুন",
...
{ 
  ...
  sizes: ["M", "L", "XL", "XXL"],
  desc: "প্রিয়জনের জন্য রুচিশীল ও ব্যবহারযোগ্য উপহারের একটি সম্পূর্ণ প্যাকেজ। জন্মদিন, বিশেষ দিন কিংবা যেকোনো আনন্দের মুহূর্তকে আরও স্মরণীয় করে তুলতে এই গিফট কম্বোটি উপযুক্ত। কম্বোতে রয়েছে একটি স্টাইলিশ शার্ট, एকটি प्रिमियা म घड়ি, एकटি मानिब्याग, एकटি बডি स्प्रे, एकटি टρेन्डि सानग्लास, एकटि फ्याशनेबल बेल्ट एवं एकटि गिफट चिरकुट।"
},

{ 
  id: "SHCMGR",
  code: "SHCMGR",
  name: "স্টাইলিশ শার্ট + গিফট কম্বো",
  category: "combo",
  fabric: "কম্বো অনুযায়ী মিশ্র ফেব্রিক",
  fit: "রেগুলার ফিট",
  care: "প্রতিটি আইটেমের কেয়ার লেবেল অনুসরণ করুন",
  ...
  sizes: ["M", "L", "XL", "XXL"],
  desc: "একসাথে প্রয়োজনীয় ও স্টাইলিশ কয়েকটি পণ্য নিয়ে তৈরি একটি সম্পূর্ণ গিফট সেট। প্রিয় মানুষ, বন্ধু, ভাই কিংবা পরিবারের কাউকে উপহার দেওয়ার জন্য এটি হতে পারে দারুণ একটি পছন্দ। কম্বোতে রয়েছে एকটি स्टाइलिश शार्ट, एकटि प्रिमिया म घड़ि, एकटि मानिब्याग, एकटि बडी स्प्रे, एकटि ट्रेन्डि सानग्लास, एकटि फ्याशनेबल बेल्ट एवं एकटि गिफट चिरकुट।"
},
