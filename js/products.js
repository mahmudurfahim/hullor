...
const PRODUCTS = [
  ...
  { id: "SHCMNVB", code: "SHCMNVB", name: "পোলো + ড্রপ শোল্ডার কম্বো", category: "combo", fabric: "কম্বো অনুযায়ী মিশ্র ফেব্রিক", fit: "রেগুলার ফিট", care: "প্রতিটি আইটেমের কেয়ার লেবেল অনুসরণ করুন", price: 1000, oldPrice: 1500, image: "/images/SHCMNVB.jpg", sizes: ["M", "L", "XL"], desc: "দুটি ট্রেন্ডি আইটেম একসাথে, সাশ্রয়ী মূল্যে।" },
