...
const PRODUCTS = [
  ...
  { featured: true, id: "combo-01", code: "HL-COMBO-01", name: "শার্ট + প্যান্ট কম্বো", category: "combo", fabric: "কম্বো অনুযায়ী মিশ্র ফেব্রিক", fit: "রেগুলার ফিট", care: "প্রতিটি আইটেমের কেয়ার লেবেল অনুসরণ করুন", price: 1550, oldPrice: 1900, image: "/images/combo1-demo.jpg", sizes: ["M", "L", "XL"], desc: "একটি শার্ট এবং একটি প্যান্টের বিশেষ কম্বো অফার, একসাথে বাঁচান।" },
  { id: "combo-02", code: "HL-COMBO-02", name: "পোলো + ড্রপ শোল্ডার কম্বো", category: "combo", fabric: "কম্বো অনুযায়ী মিশ্র ফেব্রিক", fit: "রেগুলার ফিট", care: "প্রতিটি আইটেমের কেয়ার লেবেল অনুসরণ করুন", price: 1250, oldPrice: 1450, image: "/images/combo2-demo.jpg", sizes: ["M", "L", "XL"], desc: "দুটি ট্রেন্ডি আইটেম একসাথে, সাশ্রয়ী মূল্যে।" },
